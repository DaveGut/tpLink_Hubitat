...
def setLightingEffect(effect) {
	...
	sendDevCmd(requests, "setLightingEffect", "parseUpdates")
}
...
// ~~~~~ start include (209) davegut.tpLinkCapSwitch ~~~~~
...
// ~~~~~ end include (209) davegut.tpLinkCapSwitch ~~~~~

// ~~~~~ start include (210) davegut.tpLinkCapSwitchLevel ~~~~~
...
// ~~~~~ end include (210) davegut.tpLinkCapSwitchLevel ~~~~~

// ~~~~~ start include (207) davegut.tpLinkCapColorControl ~~~~~
...
def setHue(hue){ // library marker davegut.tpLinkCapColorControl, line 14
	...
	sendDevCmd(requests, device.getDeviceNetworkId(), "parseUpdates") // library marker davegut.tpLinkCapColorControl, line 26
...
def setSaturation(saturation) { // library marker davegut.tpLinkCapColorControl, line 29
	...
	sendDevCmd(requests, device.getDeviceNetworkId(), "parseUpdates") // library marker davegut.tpLinkCapColorControl, line 39
...
def setColor(color) { // library marker davegut.tpLinkCapColorControl, line 42
	...
	sendDevCmd(requests, device.getDeviceNetworkId(), "parseUpdates") // library marker davegut.tpLinkCapColorControl, line 57
} // library marker davegut.tpLinkCapColorControl, line 58

def setColorTemperature(colorTemp, level=device.currentValue("level"), transTime = 0) { // library marker davegut.tpLinkCapColorControl, line 60
	Map logData = [method: "setColorTemperature", level: level, colorTemp: colorTemp, transTime: transTime] // library marker davegut.tpLinkCapColorControl, line 61
	if (level == null) { // library marker davegut.tpLinkCapColorControl, line 62
		level = device.currentValue("level") // library marker davegut.tpLinkCapColorControl, line 63
	} else if (level > 100 || level < 0) { // library marker davegut.tpLinkCapColorControl, line 64
		logData << [error: "level out of range"] // library marker davegut.tpLinkCapColorControl, line 65
		logWarn(logData) // library marker davegut.tpLinkCapColorControl, line 66
		return // library marker davegut.tpLinkCapColorControl, line 67
	} // library marker davegut.tpLinkCapColorControl, line 68
	def lowCt = getDataValue("ctLow").toInteger() // library marker davegut.tpLinkCapColorControl, line 69
	def highCt = getDataValue("ctHigh").toInteger() // library marker davegut.tpLinkCapColorControl, line 70
	if (colorTemp < lowCt || colorTemp > highCt || colorTemp == null) { // library marker davegut.tpLinkCapColorControl, line 71
		logData << [error: "colorTemp out of range"] // library marker davegut.tpLinkCapColorControl, line 72
		logWarn(logData) // library marker davegut.tpLinkCapColorControl, line 73
		return // library marker davegut.tpLinkCapColorControl, line 74
	} // library marker davegut.tpLinkCapColorControl, line 75
	if (level == 0) { // library marker davegut.tpLinkCapColorControl, line 76
		off() // library marker davegut.tpLinkCapColorControl, line 77
	} else if (transTime > 0) { // library marker davegut.tpLinkCapColorControl, line 78
		execCtLevelTrans(level, colorTemp, transTime) // library marker davegut.tpLinkCapColorControl, line 79
	} else { // library marker davegut.tpLinkCapColorControl, line 80
		List requests = [[method: "set_device_info", // library marker davegut.tpLinkCapColorControl, line 81
						  params: [brightness: level, // library marker davegut.tpLinkCapColorControl, line 82
								   color_temp: colorTemp]]] // library marker davegut.tpLinkCapColorControl, line 83
		requests << [method: "get_device_info"] // library marker davegut.tpLinkCapColorControl, line 84
		sendDevCmd(requests, device.getDeviceNetworkId(), "parseUpdates") // library marker davegut.tpLinkCapColorControl, line 85
	} // library marker davegut.tpLinkCapColorControl, line 86
	logDebug(logData) // library marker davegut.tpLinkCapColorControl, line 87
} // library marker davegut.tpLinkCapColorControl, line 88

def execCtLevelTrans(targetLevel, targetCt, transTime) { // library marker davegut.tpLinkCapColorControl, line 90
	Map logData = [method: "execLevelTrans", targetLevel: targetLevel, // library marker davegut.tpLinkCapColorControl, line 91
				   targetCt: targetCt, transTime: transTime] // library marker davegut.tpLinkCapColorControl, line 92
	def currLevel = device.currentValue("level") // library marker davegut.tpLinkCapColorControl, line 93
	def currCt = device.currentValue("colorTemperature")  // library marker davegut.tpLinkCapColorControl, line 94
	logData << [currLevel: currLevel, currCt: currCt] // library marker davegut.tpLinkCapColorControl, line 95
	if (targetLevel == currLevel && targetCt == currCt) { // library marker davegut.tpLinkCapColorControl, line 96
		logData << [ERROR: "No level nor CT Change. Exit."] // library marker davegut.tpLinkCapColorControl, line 97
		logWarn(logData) // library marker davegut.tpLinkCapColorControl, line 98
		return // library marker davegut.tpLinkCapColorControl, line 99
	} // library marker davegut.tpLinkCapColorControl, line 100
	if (transTime > 10) { // library marker davegut.tpLinkCapColorControl, line 101
		transTime = 10 // library marker davegut.tpLinkCapColorControl, line 102
		logData << [transTimeChange: transTime] // library marker davegut.tpLinkCapColorControl, line 103
	} // library marker davegut.tpLinkCapColorControl, line 104
	//	Determine commandDelay // library marker davegut.tpLinkCapColorControl, line 105
	def levelChange = targetLevel - currLevel // library marker davegut.tpLinkCapColorControl, line 106
	def scaledLevelChange = Math.abs(levelChange / 100) // library marker davegut.tpLinkCapColorControl, line 107
	def ctRange = getDataValue("ctHigh").toInteger() - getDataValue("ctLow").toInteger() // library marker davegut.tpLinkCapColorControl, line 108
	def ctChange = targetCt - currCt // library marker davegut.tpLinkCapColorControl, line 109
	def scaledCtChange = Math.abs(ctChange / ctRange) // library marker davegut.tpLinkCapColorControl, line 110
	def deltaLevel = 0 // library marker davegut.tpLinkCapColorControl, line 111
	if (levelChange > 0) { // library marker davegut.tpLinkCapColorControl, line 112
		deltaLevel = (0.99 + (levelChange / (4 * transTime))).toInteger()	//	next greater integer. // library marker davegut.tpLinkCapColorControl, line 113
	} else if(levelChange < 0) { // library marker davegut.tpLinkCapColorControl, line 114
		deltaLevel = (-0.99 + (levelChange / (4 * transTime))).toInteger() // library marker davegut.tpLinkCapColorControl, line 115
	} // library marker davegut.tpLinkCapColorControl, line 116
	def deltaCt = 0 // library marker davegut.tpLinkCapColorControl, line 117
	if (ctChange > 0) { // library marker davegut.tpLinkCapColorControl, line 118
		deltaCt = (0.99 + (ctChange / (4 * transTime))).toInteger() // library marker davegut.tpLinkCapColorControl, line 119
	} else if (ctChange < 0) { // library marker davegut.tpLinkCapColorControl, line 120
		deltaCt = (-0.99 + (ctChange / (4 * transTime))).toInteger() // library marker davegut.tpLinkCapColorControl, line 121
	} // library marker davegut.tpLinkCapColorControl, line 122
	def newLevel = currLevel // library marker davegut.tpLinkCapColorControl, line 123
	def newCt = currCt // library marker davegut.tpLinkCapColorControl, line 124
	def startTime = now() // library marker davegut.tpLinkCapColorControl, line 125
	if (scaledLevelChange >= scaledCtChange) { // library marker davegut.tpLinkCapColorControl, line 126
		//	calculate total increments based on level change and delta level // library marker davegut.tpLinkCapColorControl, line 127
		def incrs = (0.99 + (levelChange / deltaLevel)).toInteger() // library marker davegut.tpLinkCapColorControl, line 128
		cmdDelay = (1000 * transTime / incrs).toInteger() - 10 // library marker davegut.tpLinkCapColorControl, line 129
		logData << [cmdDelay: cmdDelay, incrs: incrs] // library marker davegut.tpLinkCapColorControl, line 130
		if (targetLevel < currLevel) { // library marker davegut.tpLinkCapColorControl, line 131
			while(targetLevel < newLevel) { // library marker davegut.tpLinkCapColorControl, line 132
				newLevel = setNewLevel(targetLevel, currLevel, newLevel, deltaLevel) // library marker davegut.tpLinkCapColorControl, line 133
				newCt = setNewCt(targetCt, currCt, newCt, deltaCt) // library marker davegut.tpLinkCapColorControl, line 134
				sendTransCmd(newLevel, newCt) // library marker davegut.tpLinkCapColorControl, line 135
				pauseExecution(cmdDelay) // library marker davegut.tpLinkCapColorControl, line 136
			}		 // library marker davegut.tpLinkCapColorControl, line 137
		} else if (targetLevel > currLevel) { // library marker davegut.tpLinkCapColorControl, line 138
			while(targetLevel > newLevel) { // library marker davegut.tpLinkCapColorControl, line 139
				newLevel = setNewLevel(targetLevel, currLevel, newLevel, deltaLevel) // library marker davegut.tpLinkCapColorControl, line 140
				newCt = setNewCt(targetCt, currCt, newCt, deltaCt) // library marker davegut.tpLinkCapColorControl, line 141
				sendTransCmd(newLevel, newCt) // library marker davegut.tpLinkCapColorControl, line 142
				pauseExecution(cmdDelay) // library marker davegut.tpLinkCapColorControl, line 143
			} // library marker davegut.tpLinkCapColorControl, line 144
		} // library marker davegut.tpLinkCapColorControl, line 145
	} else { // library marker davegut.tpLinkCapColorControl, line 146
		def incrs = (0.99 + (ctChange / deltaCt)).toInteger() // library marker davegut.tpLinkCapColorControl, line 147
		def cmdDelay = (1000 * transTime / incrs).toInteger() - 10 // library marker davegut.tpLinkCapColorControl, line 148
		logData << [cmdDelay: cmdDelay, incrs: incrs] // library marker davegut.tpLinkCapColorControl, line 149
		if (targetCt < currCt) { // library marker davegut.tpLinkCapColorControl, line 150
			while(targetCt < newCt) { // library marker davegut.tpLinkCapColorControl, line 151
				newLevel = setNewLevel(targetLevel, currLevel, newLevel, deltaLevel) // library marker davegut.tpLinkCapColorControl, line 152
				newCt = setNewCt(targetCt, currCt, newCt, deltaCt) // library marker davegut.tpLinkCapColorControl, line 153
				sendTransCmd(newLevel, newCt) // library marker davegut.tpLinkCapColorControl, line 154
				pauseExecution(cmdDelay) // library marker davegut.tpLinkCapColorControl, line 155
			}		 // library marker davegut.tpLinkCapColorControl, line 156
		} else if (targetCt > currCt) { // library marker davegut.tpLinkCapColorControl, line 157
			while(targetCt > newCt) { // library marker davegut.tpLinkCapColorControl, line 158
				newLevel = setNewLevel(targetLevel, currLevel, newLevel, deltaLevel) // library marker davegut.tpLinkCapColorControl, line 159
				newCt = setNewCt(targetCt, currCt, newCt, deltaCt) // library marker davegut.tpLinkCapColorControl, line 160
				sendTransCmd(newLevel, newCt) // library marker davegut.tpLinkCapColorControl, line 161
				pauseExecution(cmdDelay) // library marker davegut.tpLinkCapColorControl, line 162
			} // library marker davegut.tpLinkCapColorControl, line 163
		} // library marker davegut.tpLinkCapColorControl, line 164
	} // library marker davegut.tpLinkCapColorControl, line 165
	def execTime = now() - startTime // library marker davegut.tpLinkCapColorControl, line 166
	logData << [execTime: execTime] // library marker davegut.tpLinkCapColorControl, line 167
	logDebug(logData) // library marker davegut.tpLinkCapColorControl, line 168
	pauseExecution(500) // library marker davegut.tpLinkCapColorControl, line 169
	setColorTemperature(targetCt, targetLevel) // library marker davegut.tpLinkCapColorControl, line 170
} // library marker davegut.tpLinkCapColorControl, line 171

def setNewCt(targetCt, currCt, newCt, deltaCt) { // library marker davegut.tpLinkCapColorControl, line 173
	newCt += deltaCt // library marker davegut.tpLinkCapColorControl, line 174
	if ((targetCt < currCt && newCt < targetCt) || // library marker davegut.tpLinkCapColorControl, line 175
		(targetCt > currCt && newCt > targetCt)) { // library marker davegut.tpLinkCapColorControl, line 176
		newCt = targetCt // library marker davegut.tpLinkCapColorControl, line 177
	} // library marker davegut.tpLinkCapColorControl, line 178
	return newCt // library marker davegut.tpLinkCapColorControl, line 179
} // library marker davegut.tpLinkCapColorControl, line 180

def sendTransCmd(newLevel, newCt) { // library marker davegut.tpLinkCapColorControl, line 182
		List requests = [[method: "set_device_info", // library marker davegut.tpLinkCapColorControl, line 183
						  params: [ // library marker davegut.tpLinkCapColorControl, line 184
							  brightness: newLevel, // library marker davegut.tpLinkCapColorControl, line 185
							  color_temp: newCt]]] // library marker davegut.tpLinkCapColorControl, line 186
			sendDevCmd(requests, device.getDeviceNetworkId(), "") // library marker davegut.tpLinkCapColorControl, line 187
} // library marker davegut.tpLinkCapColorControl, line 188

def colorParse(result) { // library marker davegut.tpLinkCapColorControl, line 190
	Map logData = [method: "colorParse"] // library marker davegut.tpLinkCapColorControl, line 191
	if (result.color_temp != null) { // library marker davegut.tpLinkCapColorControl, line 192
		if (result.color_temp == 0) { // library marker davegut.tpLinkCapColorControl, line 193
			updateAttr("colorMode", "COLOR") // library marker davegut.tpLinkCapColorControl, line 194
			def hubHue = (result.hue / 3.6).toInteger() // library marker davegut.tpLinkCapColorControl, line 195
			updateAttr("hue", hubHue) // library marker davegut.tpLinkCapColorControl, line 196
			updateAttr("saturation", result.saturation) // library marker davegut.tpLinkCapColorControl, line 197
			updateAttr("color", "[hue: ${hubHue}, saturation: ${result.saturation}]") // library marker davegut.tpLinkCapColorControl, line 198
			def colorName = convertHueToGenericColorName(hubHue) // library marker davegut.tpLinkCapColorControl, line 199
			updateAttr("colorName", colorName) // library marker davegut.tpLinkCapColorControl, line 200
			def rgb = hubitat.helper.ColorUtils.hsvToRGB([hubHue, // library marker davegut.tpLinkCapColorControl, line 201
														  result.saturation, // library marker davegut.tpLinkCapColorControl, line 202
														  result.brightness]) // library marker davegut.tpLinkCapColorControl, line 203
			updateAttr("RGB", rgb) // library marker davegut.tpLinkCapColorControl, line 204
			updateAttr("colorTemperature", 0) // library marker davegut.tpLinkCapColorControl, line 205
			logData << [colorMode: "COLOR", colorName: colorName, RGB: rgb, colorTemperature: 0] // library marker davegut.tpLinkCapColorControl, line 206
		} else { // library marker davegut.tpLinkCapColorControl, line 207
			updateAttr("colorMode", "CT") // library marker davegut.tpLinkCapColorControl, line 208
			updateAttr("colorTemperature", result.color_temp) // library marker davegut.tpLinkCapColorControl, line 209
			def colorName = convertTemperatureToGenericColorName(result.color_temp.toInteger()) // library marker davegut.tpLinkCapColorControl, line 210
			updateAttr("hue", 0) // library marker davegut.tpLinkCapColorControl, line 211
			updateAttr("saturation", 0) // library marker davegut.tpLinkCapColorControl, line 212
			updateAttr("colorName", colorName) // library marker davegut.tpLinkCapColorControl, line 213
			updateAttr("color", "[:]") // library marker davegut.tpLinkCapColorControl, line 214
			updateAttr("RGB", "[]") // library marker davegut.tpLinkCapColorControl, line 215
			logData << [colorMode: "CT", colorName: colorName, color: color,  // library marker davegut.tpLinkCapColorControl, line 216
						RGB: RGB, colorTemperature: result.color_temp] // library marker davegut.tpLinkCapColorControl, line 217
		} // library marker davegut.tpLinkCapColorControl, line 218
	} // library marker davegut.tpLinkCapColorControl, line 219
	logDebug(logData) // library marker davegut.tpLinkCapColorControl, line 220
} // library marker davegut.tpLinkCapColorControl, line 221

// ~~~~~ end include (207) davegut.tpLinkCapColorControl ~~~~~

// ~~~~~ start include (213) davegut.tpLinkCommon ~~~~~
...
// ~~~~~ end include (213) davegut.tpLinkCommon ~~~~~

// ~~~~~ start include (214) davegut.tpLinkComms ~~~~~
...
// ~~~~~ end include (214) davegut.tpLinkComms ~~~~~

// ~~~~~ start include (215) davegut.tpLinkCrypto ~~~~~
...
// ~~~~~ end include (215) davegut.tpLinkCrypto ~~~~~
