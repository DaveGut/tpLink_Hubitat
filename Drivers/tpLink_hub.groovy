...
// ~~~~~ start include (201) davegut.tpLinkParentCommon ~~~~~
...
def installChildren(resp, data=null) { // library marker davegut.tpLinkParentCommon, line 15
	...
	def respData = parseData(resp) // library marker davegut.tpLinkParentCommon, line 18
...
logWarn("<b>HUB TEMP-HUMIDITY Sensor is a Beta Version</b>") // library marker davegut.tpLinkParentCommon, line 87
			deviceType = "Hub TempHumidity" // library marker davegut.tpLinkParentCommon, line 88
			break // library marker davegut.tpLinkParentCommon, line 89

		case "subg.trigger.water-leak-sensor": // library marker davegut.tpLinkParentCommon, line 91
			deviceType = "Hub Leak" // library marker davegut.tpLinkParentCommon, line 92
			break // library marker davegut.tpLinkParentCommon, line 93

		case "subg.trv": // library marker davegut.tpLinkParentCommon, line 95
logWarn("<b>HUB TRV is a Beta Version</b>") // library marker davegut.tpLinkParentCommon, line 96
			deviceType = "Hub Trv" // library marker davegut.tpLinkParentCommon, line 97
			break // library marker davegut.tpLinkParentCommon, line 98

		case "subg.plugswitch.switch": // library marker davegut.tpLinkParentCommon, line 100
		case "subg.plugswitch.plug": // library marker davegut.tpLinkParentCommon, line 101
logWarn("<b>Hub Plug/Switch is a Beta Version</b>") // library marker davegut.tpLinkParentCommon, line 102
			deviceType = "Hub Plug" // library marker davegut.tpLinkParentCommon, line 103
			break // library marker davegut.tpLinkParentCommon, line 104

		//	===== PARENT CONNECTED ===== // library marker davegut.tpLinkParentCommon, line 106
		case "plug.powerstrip.sub-plug": // library marker davegut.tpLinkParentCommon, line 107
			deviceType = "Child Plug" // library marker davegut.tpLinkParentCommon, line 108
			break // library marker davegut.tpLinkParentCommon, line 109

 		case "kasa.switch.outlet.sub-fan": // library marker davegut.tpLinkParentCommon, line 111
logWarn("<b>Child Fan is a Beta Version</b>") // library marker davegut.tpLinkParentCommon, line 112
			deviceType = "Child Fan" // library marker davegut.tpLinkParentCommon, line 113
			break // library marker davegut.tpLinkParentCommon, line 114

 		case "kasa.switch.outlet.sub-dimmer": // library marker davegut.tpLinkParentCommon, line 116
		case "plug.powerstrip.sub-bulb": // library marker davegut.tpLinkParentCommon, line 117
			deviceType = "Child Dimmer" // library marker davegut.tpLinkParentCommon, line 118
			break // library marker davegut.tpLinkParentCommon, line 119

		default: // library marker davegut.tpLinkParentCommon, line 121
			deviceType = "Child Undefined" // library marker davegut.tpLinkParentCommon, line 122
	} // library marker davegut.tpLinkParentCommon, line 123
	return deviceType // library marker davegut.tpLinkParentCommon, line 124
} // library marker davegut.tpLinkParentCommon, line 125

//	Data Distribution // library marker davegut.tpLinkParentCommon, line 127
def distChildGetData(devResp, data) { // library marker davegut.tpLinkParentCommon, line 128
	def child = getChildDevice(data.data) // library marker davegut.tpLinkParentCommon, line 129
	switch(devResp.method) { // library marker davegut.tpLinkParentCommon, line 130
		case "get_device_info": // library marker davegut.tpLinkParentCommon, line 131
			child.parse_get_device_info(devResp.result, data) // library marker davegut.tpLinkParentCommon, line 132
			child.parseNameUpdate(devResp.result) // library marker davegut.tpLinkParentCommon, line 133
			break // library marker davegut.tpLinkParentCommon, line 134
		case "get_current_power": // library marker davegut.tpLinkParentCommon, line 135
			child.parse_get_current_power(devResp.result, data) // library marker davegut.tpLinkParentCommon, line 136
			break // library marker davegut.tpLinkParentCommon, line 137
		case "get_device_usage": // library marker davegut.tpLinkParentCommon, line 138
			child.parse_get_device_usage(devResp.result, data) // library marker davegut.tpLinkParentCommon, line 139
			break // library marker davegut.tpLinkParentCommon, line 140
		case "get_trigger_logs": // library marker davegut.tpLinkParentCommon, line 141
			child.parse_get_trigger_log(devResp.result, data) // library marker davegut.tpLinkParentCommon, line 142
			break // library marker davegut.tpLinkParentCommon, line 143
		default: // library marker davegut.tpLinkParentCommon, line 144
			if (!devResp.method.contains("set_")) { // library marker davegut.tpLinkParentCommon, line 145
				Map logData = [method: "distGetData", data: data, // library marker davegut.tpLinkParentCommon, line 146
							   devMethod: devResp.method, status: "unprocessed"] // library marker davegut.tpLinkParentCommon, line 147
				logDebug(logData) // library marker davegut.tpLinkParentCommon, line 148
			} // library marker davegut.tpLinkParentCommon, line 149
	} // library marker davegut.tpLinkParentCommon, line 150
} // library marker davegut.tpLinkParentCommon, line 151

def parse_get_child_device_list(result, data) { // library marker davegut.tpLinkParentCommon, line 153
	Map logData = [method: "get_child_device_list", data: data] // library marker davegut.tpLinkParentCommon, line 154
	def children = getChildDevices() // library marker davegut.tpLinkParentCommon, line 155
	children.each { child -> // library marker davegut.tpLinkParentCommon, line 156
		def devId = child.getDataValue("deviceId") // library marker davegut.tpLinkParentCommon, line 157
		def childData = result.child_device_list.find{ it.device_id == devId } // library marker davegut.tpLinkParentCommon, line 158
		child.parse_get_device_info(childData, data) // library marker davegut.tpLinkParentCommon, line 159
	} // library marker davegut.tpLinkParentCommon, line 160
	logData << [status: "OK"] // library marker davegut.tpLinkParentCommon, line 161
	logDebug(logData) // library marker davegut.tpLinkParentCommon, line 162
} // library marker davegut.tpLinkParentCommon, line 163

// ~~~~~ end include (201) davegut.tpLinkParentCommon ~~~~~
