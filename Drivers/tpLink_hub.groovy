...
def getAlarmConfig() {
	List requests = [[method: "set_on_off_gradually_info", params: [enable: gradualOnOff]]]
...
def parentPreferences() { // library marker davegut.lib_tpLink_parents, line 10
	...
	input ("childPollInt", "enum", title: "CHILD DEVICE Poll interval (seconds)", // library marker davegut.lib_tpLink_parents, line 12
...
def pollChildren() { // library marker davegut.lib_tpLink_parents, line 29
	...
	asyncPassthrough(cmdBody, "pollChildren", "childPollParse") // library marker davegut.lib_tpLink_parents, line 33
...
def installChildDevices() { // library marker davegut.lib_tpLink_parents, line 49
	def logData = [:] // library marker davegut.lib_tpLink_parents, line 50
	def respData = syncPassthrough([method: "get_child_device_list"]) // library marker davegut.lib_tpLink_parents, line 51
	def children = respData.result.child_device_list // library marker davegut.lib_tpLink_parents, line 52
	children.each { // library marker davegut.lib_tpLink_parents, line 53
		String childDni = it.mac // library marker davegut.lib_tpLink_parents, line 54
		logData << [childDni: childDni] // library marker davegut.lib_tpLink_parents, line 55
		def isChild = getChildDevice(dni) // library marker davegut.lib_tpLink_parents, line 56
		byte[] plainBytes = it.nickname.decodeBase64() // library marker davegut.lib_tpLink_parents, line 57
		String alias = new String(plainBytes) // library marker davegut.lib_tpLink_parents, line 58
		if (isChild) { // library marker davegut.lib_tpLink_parents, line 59
			logInfo("installChildDevices: [${alias}: device already installed]") // library marker davegut.lib_tpLink_parents, line 60
		} else { // library marker davegut.lib_tpLink_parents, line 61
			String model = it.model // library marker davegut.lib_tpLink_parents, line 62
			String category = it.category // library marker davegut.lib_tpLink_parents, line 63
			String driver = getDriverId(category, model) // library marker davegut.lib_tpLink_parents, line 64
			String deviceId = it.device_id // library marker davegut.lib_tpLink_parents, line 65
			def instData = [childDni: childDni, model: model, category: category, driver: driver]  // library marker davegut.lib_tpLink_parents, line 66
			try { // library marker davegut.lib_tpLink_parents, line 67
				addChildDevice("davegut", driver, childDni,  // library marker davegut.lib_tpLink_parents, line 68
							   [label: alias, name: model, deviceId : deviceId]) // library marker davegut.lib_tpLink_parents, line 69
				logInfo("installChildDevices: [${alias}: Installed, data: ${instData}]") // library marker davegut.lib_tpLink_parents, line 70
			} catch (e) { // library marker davegut.lib_tpLink_parents, line 71
				logWarn("installChildDevices: [${alias}: FAILED, data ${instData}, error: ${e}]") // library marker davegut.lib_tpLink_parents, line 72
			} // library marker davegut.lib_tpLink_parents, line 73
		} // library marker davegut.lib_tpLink_parents, line 74
		logData << ["${alias}": "complete"] // library marker davegut.lib_tpLink_parents, line 75
	} // library marker davegut.lib_tpLink_parents, line 76
	if (logData.status == "Failed") { // library marker davegut.lib_tpLink_parents, line 77
		logWarn("installChildDevices: <b>${logData}</b>") // library marker davegut.lib_tpLink_parents, line 78
	} else { // library marker davegut.lib_tpLink_parents, line 79
		logInfo("installChildDevices: ${logData}") // library marker davegut.lib_tpLink_parents, line 80
	} // library marker davegut.lib_tpLink_parents, line 81
