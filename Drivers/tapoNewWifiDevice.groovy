/*	tapo NEW Wifi Device
		Copyright Dave Gutheinz
License:  https://github.com/DaveGut/HubitatActive/blob/master/KasaDevices/License.md

=================================================================================================*/
def type() {return "tapoNewWifiDevice" }
...
def updated() {
	unschedule()
	Map logData = [:]
	def mssg = "The developer requires data to complete the development of this driver.\n\r"
	msg += "\t\tRun the command getDeveloperData and Private Message the log data to @davegut."
	logWarn("<b>${msg}</b>")
	state.a_NOTICE = msg
